...
import { motion } from "framer-motion"; // Corr
    ...
    <section id="About_me">
      <div className="border-b border-neutral-900 pb-4">
        ...
        <div className="flex flex-wrap">
          {/* Left section - Image */}
          <motion.div whileInView={{x:0,opacity:1}} initial={{x:-100,opacity:0}} transition={{dutation:1.0}}  className="w-full lg:w-1/2 lg:p-8">
...
/>
          ...
          <motion.div whileInView={{x:0,opacity:1}} initial={{x:100,opacity:0}} transition={{dutation:1.0}}  className="w-full lg:w-1/2">
